...
func TestGameStateSnapshotForPlayer(t *testing.T) {
	...
	first.unadjustedTotalPoints = 17
	...
	if snapshot.Players[0].PlayerID != "first" || snapshot.Players[0].HandCount != 2 || snapshot.Players[0].TotalPoints != 12 || snapshot.Players[0].PointsGained != 5 || snapshot.Players[0].UnadjustedTotalPoints != 17 || !snapshot.Players[0].HasOpened {
